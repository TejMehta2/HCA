...
const FormBuilderExample = (): JSX.Element => {
  return (
    <div
      data-byoc-sitecore-form
      data-external-id="SitecoreForm?formId=aea26483d65d4d66b96ca53e9a60a5e5-euw"
      form-id="aea26483d65d4d66b96ca53e9a60a5e5-euw"
      sitecore-edge-url="https://edge-platform.sitecorecloud.io"
      sitecore-edge-context-id=""
    >
      <div
        className="main-form-wrapper lp-flex-container lp-flex-justify-center lp-flex-align-center wrapper-aea26483d65d4d66b96ca53e9a60a5e5-euw"
      ...
      >
        ...
        <form
          className="content lp-flex-container lp-flex-1 lp-flex-direction-vertical lp-flex-1"
          data-formid="aea26483d65d4d66b96ca53e9a60a5e5-euw"
          data-fail-action="message"
        >
          <div
            data-page-index="0"
            className="form-page"
            style={{ display: 'flex', opacity: 1, flexDirection: 'column' }}
          >
            <div
              data-structure-type="row"
              id="2d7ddd9a57d048ec8bf0b120308da187"
              className="landing-page-row row2d7ddd9a57d048ec8bf0b120308da187 lp-ie-flex-shrink"
            >
              <div className="inner-row-div">
                <div className="border-wrapper">
                  <div className="row-slot-wrapper lp-flex-container">
                    <div
                      className="landing-page-slot lp-flex-container lp-flex-direction-vertical slote9941cb2c877490a9ee2829c032a4787 FULL"
                      id="e9941cb2c877490a9ee2829c032a4787"
                      data-structure-type="slot"
                    >
                      <div className="slot-container lp-flex-container lp-flex-direction-vertical lp-ie-flex-shrink">
                        <div
                          className="component text-component text-desktop textb63dcc6c3577460b942c40a9e3c43f9e"
                          data-component-type="text"
                          id="b63dcc6c3577460b942c40a9e3c43f9e"
                        >
                          <p style={{ margin: '0px' }}>
                        ...
                        <div
                          id="db93efd871644a4ba45e5b1567455594"
                          className="component email_input-component email_inputdb93efd871644a4ba45e5b1567455594"
                        >
                          <label className="form-input-wrapper-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">Email</span>
                            <div className="lp-flex-1 form-input-wrapper-div">
                              <input
                                id="email_input-db93efd871644a4ba45e5b1567455594"
                                data-id="db93efd871644a4ba45e5b1567455594"
                                className="lp-flex-1 form-input-element form-input-wrapper"
                                data-type="email_input"
                                data-label="Email"
                                data-required="false"
                                type="email"
                        ...
                        <div
                          id="f306c4d04d4041a3a583641a47bc07ba"
                          className="component text_input-component text_inputf306c4d04d4041a3a583641a47bc07ba"
                        >
                          <label className="form-input-wrapper-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">Your name</span>
                            <div className="lp-flex-1 form-input-wrapper-div">
                              <input
                                id="text_input-f306c4d04d4041a3a583641a47bc07ba"
                                data-id="f306c4d04d4041a3a583641a47bc07ba"
                                className="lp-flex-1 form-input-element form-input-wrapper"
                                ...
                                value=""
                              />
                              <div className="limit-counter">0/200</div>
                            </div>
                          </label>
                          <div className="form-input-description">
                            Help text...
                        ...
                        <div
                          id="a13c8e06407147cea808128ee3238757"
                          className="component phone_input-component phone_inputa13c8e06407147cea808128ee3238757"
                        >
                          <label className="form-input-wrapper-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            ...
                            <div className="lp-flex-1 form-input-wrapper-div">
                              <div className="iti iti--allow-dropdown iti--show-flags">
                                <div className="iti__flag-container">
                                  ...
                                  >
                                    <li
                                      className="iti__country iti__preferred iti__active iti__highlight"
                                      tabIndex={-1}
                                    ...
                                    >
                                      ...
                                      <span className="iti__country-name">
                                        São Tomé and Príncipe (São Tomé e
                                        Príncipe)
                                      </span>
                                      <span className="iti__dial-code">
                                        +239
                                ...
                                <input
                                  id="phone_input-a13c8e06407147cea808128ee3238757"
                                  data-id="a13c8e06407147cea808128ee3238757"
                                  className="lp-flex-1 form-input-element form-input-wrapper"
                                  data-type="phone_input"
                                  data-label="Phone"
                                  data-required="false"
                                  type="tel"
                                  name="phone_ebc28"
                        ...
                        <div
                          id="60ee6b6b310046e9afc222bb600bb339"
                          className="component radio-component radio-group60ee6b6b310046e9afc222bb600bb339 form-input-wrapper"
                        >
                          <div className="form-input-wrapper-element lp-flex-container lp-flex-direction-vertical form-input-undefined">
                            <span className="form-field-label form-group-label">
                              Contact me
                            </span>
                            <div className="radio-group-container">
                              <div className="radio-wrapper">
                                <label className="form-input-wrapper-element lp-flex-container lp-flex-direction-horizontal lp-flex-align-center radio60ee6b6b310046e9afc222bb600bb339">
                                  <div className="form-input-wrapper-div">
                                    <input
                                      className="form-input-radio-element form-input-element"
                                      data-type="radio"
                                      data-label="By email"
                                      data-required="false"
                                      type="radio"
                              ...
                              <input
                                data-id="60ee6b6b310046e9afc222bb600bb339"
                        ...
                        <div
                          id="e7c99115b5564ca397fc20f8fa78f65d"
                          className="component checkbox-group-component checkbox-groupe7c99115b5564ca397fc20f8fa78f65d form-input-wrapper"
                        >
                          <div className="form-input-wrapper-element lp-flex-container lp-flex-direction-vertical form-input-undefined">
                            <span className="form-field-label form-group-label">
                              Checkbox Group
                            ...
                            <div
                              ...
                              data-options-limit="0"
                            >
                              <div className="checkbox-wrapper">
                                <div
                                  id="e7c99115b5564ca397fc20f8fa78f65d0"
                                  className="component checkbox-component checkboxe7c99115b5564ca397fc20f8fa78f65d0 form-input-wrapper"
                                >
                                  <label className="form-input-wrapper-element lp-flex-container lp-flex-direction-horizontal lp-flex-align-center form-input-undefined">
                                    <div className="form-input-wrapper-div">
                                      <input
                                        data-id="e7c99115b5564ca397fc20f8fa78f65d0"
                                        ...
                                        name="checkbox_group_baefb"
                                        data-is-checkbox-group="true"
                                        value="Option 1"
                                      />
                                      <span className="checkbox-check-marker mdi mdi-check"></span>
                                    </div>
                                    <span className="form-field-label">
                                      Option 1
                                    </span>
                              ...
                              <div className="checkbox-wrapper">
                                <div
                                  id="e7c99115b5564ca397fc20f8fa78f65d1"
                                  className="component checkbox-component checkboxe7c99115b5564ca397fc20f8fa78f65d1 form-input-wrapper"
                                >
                                  <label className="form-input-wrapper-element lp-flex-container lp-flex-direction-horizontal lp-flex-align-center form-input-undefined">
                                    <div className="form-input-wrapper-div">
                                      <input
                                        data-id="e7c99115b5564ca397fc20f8fa78f65d1"
                                        className="form-input-checkbox-element form-input-element"
                                        data-type="checkbox"
                                        data-label="Option 2"
                                        data-required="false"
                              ...
                              <div className="checkbox-wrapper">
                                <div
                                  id="e7c99115b5564ca397fc20f8fa78f65d2"
                                  className="component checkbox-component checkboxe7c99115b5564ca397fc20f8fa78f65d2 form-input-wrapper"
                                >
                                  <label className="form-input-wrapper-element lp-flex-container lp-flex-direction-horizontal lp-flex-align-center form-input-undefined">
                                    <div className="form-input-wrapper-div">
                                      <input
                                        data-id="e7c99115b5564ca397fc20f8fa78f65d2"
                                        className="form-input-checkbox-element form-input-element"
                                        data-type="checkbox"
                                        data-label="Option 3"
                                        data-required="false"
                              ...
                              <input
                                data-id="e7c99115b5564ca397fc20f8fa78f65d"
                        ...
                        <div
                          id="e5bea6d11a6c4fc2951e3f7fa183c157"
                          className="component date_input-component date_inpute5bea6d11a6c4fc2951e3f7fa183c157"
                        >
                          <label className="form-input-wrapper-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">Date</span>
                            <div className="lp-flex-1 form-input-wrapper-div">
                              <input
                                id="date_input-e5bea6d11a6c4fc2951e3f7fa183c157"
                                data-id="e5bea6d11a6c4fc2951e3f7fa183c157"
                                className="lp-flex-1 form-input-element form-input-wrapper"
                                data-type="date_input"
                                data-label="Date"
                                data-required="false"
                                type="date"
                                placeholder=""
                        ...
                        <div
                          id="4d7c31362fea4c119eca48052a66d157"
                          className="component multiselect_input-component multiselect_input4d7c31362fea4c119eca48052a66d157 form-input-wrapper"
                        >
                          <label className="form-input-wrapper-element form-input-select-element form-input-multiselect-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">
                              Select one ore more
                            </span>
                            <div className="lp-flex-1">
                              <input
                                data-id="4d7c31362fea4c119eca48052a66d157"
                                className="lp-flex-1 form-input-element multiselect-input"
                                placeholder="Please select"
                                readOnly={false}
                                data-label="Select one ore more"
                                data-type="multiselect_input"
                                data-required="false"
                                name="multiselect_2629b"
                                type=""
                                data-readonly="false"
                                data-values="[]"
                                value=""
                            ...
                            >
                              ...
                              >
                                <span className="selected-indicator mdi"></span>
                                <span className="text-indicator">Option 1</span>
                              </div>
                              <div
                                data-value="Option 2"
                                className="form-select-option"
                              >
                                <span className="selected-indicator mdi"></span>
                                <span className="text-indicator">Option 2</span>
                              </div>
                              <div
                                data-value="Option 3"
                                className="form-select-option"
                              >
                                <span className="selected-indicator mdi"></span>
                                <span className="text-indicator">Option 3</span>
                              </div>
                            </div>
                        ...
                        <div
                          id="f05a32a10ff248f68361aaf1dc2e2049"
                          className="component singleselect_input-component singleselect_inputf05a32a10ff248f68361aaf1dc2e2049 form-input-wrapper"
                        >
                          <label className="form-input-wrapper-element form-input-select-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">
                              Select one option
                            </span>
                            <div className="lp-flex-1">
                              <input
                                data-id="f05a32a10ff248f68361aaf1dc2e2049"
                                className="lp-flex-1 form-input-element"
                                placeholder="Please select"
                                readOnly={false}
                                data-label="Select one option"
                                data-type="singleselect_input"
                                data-required="false"
                                name="singleselect_ed0c0"
                                type=""
                                data-readonly="false"
                                value=""
                              />
                        ...
                        <div
                          id="b276751a2e554065bcd46cf05f119458"
                          className="component number_input-component number_inputb276751a2e554065bcd46cf05f119458"
                        >
                          <label className="form-input-wrapper-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">Number</span>
                            <div className="lp-flex-1 form-input-wrapper-div">
                              <input
                                id="number_input-b276751a2e554065bcd46cf05f119458"
                                data-id="b276751a2e554065bcd46cf05f119458"
                                className="lp-flex-1 form-input-element form-input-wrapper"
                                data-type="number_input"
                                data-label="Number"
                                data-required="false"
                                type="number"
                        ...
                        <div
                          id="32f24e36135f4bbcb0a5700032f71fc0"
                          className="component longtext_input-component longtext_input32f24e36135f4bbcb0a5700032f71fc0"
                        >
                          <label className="form-input-wrapper-element lp-flex-container form-input-undefined lp-flex-direction-vertical element-vertical-ie">
                            <span className="form-field-label">
                              Your message
                            ...
                            <div className="lp-flex-1 form-input-wrapper-div">
                              <textarea
                                data-id="32f24e36135f4bbcb0a5700032f71fc0"
                                className="lp-flex-1 form-input-element"
                                data-label="Your message"
                                data-required="false"
                                placeholder="message"
                                name="long_text_f2056"
                                rows={4}
                                maxLength={1000}
                                style={{ resize: 'none' }}
                              ></textarea>
                              <div className="limit-counter">0/1000</div>
                            </div>
                          </label>
                          <div className="form-input-description">
                            Help text...
                        ...
                        <div
                          id="dec6aef908304db7a9443f0e00f0afd8"
                          className="component checkbox-component checkboxdec6aef908304db7a9443f0e00f0afd8 form-input-wrapper"
                        >
                          <label className="form-input-wrapper-element lp-flex-container lp-flex-direction-horizontal lp-flex-align-center form-input-undefined">
                            <div className="form-input-wrapper-div">
                              <input
                                data-id="dec6aef908304db7a9443f0e00f0afd8"
                                className="form-input-checkbox-element form-input-element"
                                data-type="checkbox"
                                data-label="Please send me the personalized emails with updates, special offers, and news"
                                data-required="false"
                                type="checkbox"
                                placeholder="Checkbox"
                                name="checkbox_11e53"
                            ...
                            <span className="form-field-label">
                              Please send me the personalized emails with
                              updates, special offers, and news
                            </span>
                          </label>
                        </div>
                        <div
                          id="a8f62deadf934d998b92f2d89a5f3b38"
                          className="component checkbox-component checkboxa8f62deadf934d998b92f2d89a5f3b38 form-input-wrapper"
                        >
                          <label className="form-input-wrapper-element lp-flex-container lp-flex-direction-horizontal lp-flex-align-center form-input-undefined">
                            <div className="form-input-wrapper-div">
                              <input
                                data-id="a8f62deadf934d998b92f2d89a5f3b38"
                                className="form-input-checkbox-element form-input-element"
                                data-type="checkbox"
                                data-label="I accept the terms and conditions"
                                data-required="true"
                                type="checkbox"
                                placeholder="Checkbox"
                                name="gdpr_checkbox_31ce4"
                                required={false}
                                value=""
                              />
                              <span className="checkbox-check-marker mdi mdi-check"></span>
                        ...
                        <div
                          className="component button-component lp-flex-container lp-flex-align-center buttonfa3289457a144d8481eb3e5a73408ee8"
                          id="fa3289457a144d8481eb3e5a73408ee8"
                          data-component-type="submit_button"
                        >
                          <button className="lp-flex-container lp-flex-align-center lp-flex-justify-center submit-button">
                            Submit
                          </button>
                        </div>
                        <div className="lp-flex-container lp-flex-align-center">
                          <div className="message-popup success-popup"></div>
                          <div className="message-popup fail-popup">
                            <p
                              style={{
                                textAlign: 'center',
          ...
          <input
            type="hidden"
            name="signature_aea26483d65d4d66b96ca53e9a60a5e5-euw"
            value="29FS8P7RGqckaHZCLV/Gzk0wE3JNBfm0mREKIQu9qc2O/DQ4+qTJLL38vV94pcG7bGoAaxoatd4j++MQI4licQ=="
          />
        </form>
      </div>
    </div>
