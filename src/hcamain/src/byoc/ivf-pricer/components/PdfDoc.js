    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                {
                    props.hcaLogo !== null &&
                    <Image style={styles.logo} src={`${props.urlHost}${props.hcaLogo}`} alt="HCA" />
                }
                ...
                <View style={styles.row}>
                    ...
                    <Text style={styles.selectionHeader}>{props.pdfTableColumn2Heading}</Text>
                    <Text style={styles.costHeader}>{props.pdfTableColumn3Heading}</Text>
                    <Text style={styles.descriptionHeader}>{props.pdfTableColumn4Heading}</Text>
                </View>
                ...
                {/* if there are adjuvants selections then render extra information with link */}
                {
                    ...
                    <View style={styles.row}>
                        <Text style={[styles.label, { borderTopColor: '#FFFFFF', paddingTop: 0 }]}></Text>
                        <Text style={[styles.selection, { borderTopColor: '#FFFFFF', paddingTop: 0 }]}></Text>
                        <Text style={[styles.cost, { borderTopColor: '#FFFFFF', paddingTop: 0 }]}></Text>
                        <Text style={[styles.description, { borderTopColor: '#FFFFFF', paddingTop: 0 }]}>
                            <View style={[styles.col, { fontSize: 9 }]}>
                                {
                                    props.adjuvantsExtraNotes !== null && props.adjuvantsExtraNotes.length > 0 &&
                                    <Text>{props.adjuvantsExtraNotes}</Text>
                                }
                                {
                                    props.adjuvantsExtraNotesLink !== null && props.adjuvantsExtraNotesLink.length > 0 &&
                                    <Link src={props.adjuvantsExtraNotesLink} style={styles.link}>
                                        <Text style={styles.linkSecondary}>{props.adjuvantsExtraNotesLink}</Text>
                                    </Link>
                                }
                            </View>
                        </Text>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={styles.description}>{props.selectedDrugNotes + "\n\n" + props.cycleTypeAdditionalDrugNotes}</Text>
                </View>

                {/* Total */}
                <View style={styles.total}>
                    <Text style={styles.total}>
                        {props.pdfTableItemTotalCostHeading}
                    </Text>
                ...
                <View style={styles.row}>
                    ...
                    {
                        props.pdfFurtherInformationBody !== null && props.pdfFurtherInformationBody.length > 0 &&
                        <Text style={styles.colHeader}>
                ...
                <View style={styles.row}>
                    <Text style={styles.col}>
                        {props.pdfWhatHappensNextBody}
                    </Text>
                    <Text style={styles.col}>
                        {props.pdfFurtherInformationBody}
                    </Text>
                </View>
                ...
                {/* Phone number link */}
                {
                    ...
                    <View style={styles.row}>
                        <View style={[styles.col, { fontSize: '18px', color: '#34787F', marginTop: '5px' }]}>
                            <Link src={`tel:${props.pdfWhatHappensNextPhoneNumber.replace(/\s/g, "")}`} style={styles.link}>
