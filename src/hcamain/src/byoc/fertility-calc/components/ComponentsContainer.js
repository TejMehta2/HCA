...
export default function ComponentsContainer() {
    const {
        ...
        noResults,
        noResultsMsg,
        closeNoResults } = useContext(FertilityCalculatorContext);
    return (
        <>
            {
                !isError && <div>
            ...
            {
                isError && <div>An error occured. Please try again or contact support.</div>
            }
            {
                isLoadingContent && <div className="overlay">
            ...
            {
                isServerError && <div className="overlay">
                    <div className="overlay__loader">
