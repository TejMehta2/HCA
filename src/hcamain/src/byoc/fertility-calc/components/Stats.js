    ...
    <>
      <div className="stats" id="fc__stats" ref={myRef}>
        ...
        <div className="stats__cards-container">
          <div className="card">
            <Label
              headerTitle={treatmentMainLabel}
              helpText={treatmentHelpText}
              id={false}
              isLabel={false}
              rightAligned={false}
            />
            <div className="card__data">
              ...
              <div className="card__rate">
                <div className="card__rate-stats-container">
                  ...
                  <div className="card__rate-percentage">
                    {treatmentCyclePregancyRate}
                  </div>
                </div>
              ...
              <div className="card__rate cart__rate--border-bttm-0">
                <div className="card__rate-stats-container">
                  ...
                  <div className="card__rate-percentage card__rate-percentage--green">
                    {treatmentCycleBirthRate}
                  </div>
                </div>
                <div className="card__rate-data-container">
          ...
          <div className="card">
            <Label
              headerTitle={eggCollectionMainLabel}
              helpText={eggCollectionHelpText}
              id={false}
              isLabel={false}
              rightAligned={false}
            />
          ...
          <div className="card">
            <Label
              headerTitle={embryoTransferMainLabel}
              helpText={embryoTransferHelpText}
              id={false}
              isLabel={false}
              rightAligned={true}
            />
