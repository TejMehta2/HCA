...
export interface C_condition {
  parentName?: string;
  keywordName?: string;
  childKeyword?: string;
}

export enum C_hCAFinderWeighting {
  _80 = '80',
  _60 = '60',
  _40 = '40',
  _20 = '20',
...
export interface C_healthCheck {
  parentName?: string;
  keywordName?: string;
  childKeyword?: string;
}
...
export interface C_procedure {
  parentName?: string;
  keywordName?: string;
  childKeyword?: string;
}

export interface C_registrationBodies {
  bodyID?: number;
  bodyName?: string;
...
export default interface HealthcareProfessional {
  ...
  c_aIContentGenFAQ?: string;
  c_aIGeneratedBio?: string;
  c_aIGeneratedLeafletText?: string;
  c_associatedLocationIDs?: string[];
  c_averageRating?: number;
  c_bedsideManner?: number;
  c_body?: string;
  c_condition?: C_condition[];
  c_distance?: number;
  c_educationDetails?: string;
  c_excludeOnlyAddressFromETL?: boolean;
  c_exemptFromETL?: boolean;
  c_explanation?: number;
  c_googlePhoneNumber?: number;
  c_hCAFinderWeighting?: C_hCAFinderWeighting;
  c_healthCheck?: C_healthCheck[];
  c_hPPrimarySpecialty?: string;
  c_linkedLocations?: EntityReference[];
  c_linkedProfessionals?: EntityReference[];
  c_medicalProcedures?: string[];
  c_micrositeBrand?: C_micrositeBrand[];
  c_overallExperience?: number;
  c_peerRecommendationsCount?: number;
  c_practicesAtLocation?: string[];
  c_procedure?: C_procedure[];
  c_registrationBodies?: C_registrationBodies[];
  c_reviewsCount?: number;
  c_specialInterests?: string[];
  c_specialty?: C_specialty[];
  c_suffix?: string;
  c_contentGenTest?: string;
  c_title?: string;
  c_totalReviews?: number;
  c_videoConsultations?: boolean;
  c_yearsAsSpecialist?: number;
  c_yearsOfExperience?: number;
