...
The StatsCards component displays a header, body copy, and 5 different stats. This all animate by incrementing up to the specified number

It is intended to be used on the careers homepage.

This component will only ever show 5 stats. No more, no less
