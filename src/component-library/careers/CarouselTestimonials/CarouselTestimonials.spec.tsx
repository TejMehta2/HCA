  ...
  slides: [
    {
      ...
      body: (
        <Text tag="p" variation="body-large">
          “At HCA UK, you have everything you need to deliver brilliant patient
          care in an inspiring environment- and we&apos;re always looking for
          ways to push the boundaries.
          <br />
          <br />
          There&apos;s a real focus on giving you the opportunities you need to
          follow your interests and progress quickly. My career journey is a
          good example of that.
          <br />
          <br />I really appreciate that I get to work so closely with clinical
          and non-clinical experts. As nurses, we have fantastic access to
          renowned consultants and other highly-skilled specialists.”
        </Text>
      ),
      name: (
