...
### Description
Desktop users can hover over the menu item to reveal more details. However, if they do click on an item (such as Service lines) the following dataLayer could should be loaded on the click
### Code
```
<script>
...
### Description
When a user clicks on a desktop menu item, such as Cancer Care under Service Lines, the following dataLayer could should be loaded on the click
### Code
```
<script>
window.dataLayer = window.dataLayer || [];
...
### Description
When a user clicks to open a sub menu within the mobile navigation, for example the Service Lines option within the Services & Treatments menu, the following should be sent into the dataLayer
### Code
```
<script>
window.dataLayer = window.dataLayer || [];
...
### Description
When a user clicks on a mobile menu item, such as Cancer Care under Service Lines, the following dataLayer could should be loaded on the click
### Code
```
<script>
window.dataLayer = window.dataLayer || [];
...
### Description
When a user clicks on one of the desktop View all text links, such as the View all button under Service Lines in the Services & Treatments menu, the following code when be fired on click
### Code
```
<script>
window.dataLayer = window.dataLayer || [];
...
### Description
When a user clicks on one of the mobile View all text links, such as the View all button under Service Lines in the Services & Treatments menu, the following code when be fired on click
### Code
```
<script>
window.dataLayer = window.dataLayer || [];
