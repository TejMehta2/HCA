        ...
        <div className={styles['item-title']}>
          ...
          <button
            ...
            onClick={(e) => {
              e.preventDefault();
              router.push(
                `${props.liveBookingFormStepSlotSelect}?slug=${props.slug}&name=${encodeURIComponent(props.name || '')}&gmcNumber=${props.gmcNumber}&isFollowOnAppointment=${props.isFollowUpAppointment}&reviewsTotal=${props.reviewsTotal}`
              );
            }}
          >
            <Icons iconName="iconEdit" />
