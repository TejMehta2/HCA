...
The ShareCTA component is displays a heading, subheading and share buttons in a modal on desktop. On mobile it uses the Web Share API which will open native sharing options when the button is clicked.
