...
export const Default: StoryObj<typeof CarouselReviews> = {
  args: {
    rating: <span>4.85</span>,
    reviewCount: <span>13,500+ reviews</span>,
    children: [
      <React.Fragment key={1}>
        <Text tag="p" variation="body-extra-large">
          All the staff and services at The Wellington were exemplary. It was
          like being treated in a 6* hospital within a 4-5* star hotel. All my
          needs were immediately attended to. The team had the utmost patience
          and flexibility
        </Text>
        <Text tag="p" variation="body-extra-large">
